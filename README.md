[![Build Status](https://travis-ci.com/taktikorg/perferendis-voluptate-illum.svg?branch=main)](https://travis-ci.com/taktikorg/perferendis-voluptate-illum)
...
[![Maintainability](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/maintainability)](https://codeclimate.com/github/taktikorg/perferendis-voluptate-illum/maintainability)
[![Test Coverage](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/test_coverage)](https://codeclimate.com/github/taktikorg/perferendis-voluptate-illum/test_coverage)
...
Install it using npm: `npm install @taktikorg/perferendis-voluptate-illum`

If used in a browser environment, you will need to manually install the local you wish to support.

```javascript
var languages = require("@taktikorg/perferendis-voluptate-illum");

// Support german & english languages.
languages.registerLocale(require("@taktikorg/perferendis-voluptate-illum/langs/en.json"));
languages.registerLocale(require("@taktikorg/perferendis-voluptate-illum/langs/de.json"));
```
